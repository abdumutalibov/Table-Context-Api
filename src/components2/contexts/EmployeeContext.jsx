...
const [employees, setEmployees] =useState([
  {id:uuidv4(), img:'', name: 'Thomas Hardy10', email: 'thomashardy@mail.com', address: '89 Chiaroscuro Rd, Portland, USA', phone: '(171) 555-2222'},
...
const updateEmployee =(id , updateEmloyee)=>{
  setEmployees(employees.map((employee)=>employee.id === id ? updateEmloyee:employee))
}
  return (
